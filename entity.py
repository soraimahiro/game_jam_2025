...
ENEMIES = {
	...
	2: (
		Entity("type_simple/image_mob_move",		Entity.T_MONSTER,	2,		1,	Vector2(0, 0),	Vector2(1, 0),	1,	1,	0b1111),
	...
	4: (
		Entity("monsters/image_monster2_mob_move",	Entity.T_MONSTER,	5, 		1,	Vector2(0, 0),	Vector2(1, 0),	3,	1,	0b0011),
